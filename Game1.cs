...
namespace Monogame_Topic_5
{
    public class Game1 : Game
    {
        ...
        SoundEffectInstance aria;
        SpriteFont titleFont;
        Texture2D tribbleBackground, tribbleBGSad, tribbleBackgroundBrown, tribbleBackgroundCream, tribbleBackgroundGrey, tribbleBackgroundOrange;
        Rectangle bgRect, bgSadRect;
        ...
        protected override void Initialize()
        {
            ...
            bgSadRect = new(0, 0, 800, 600);

            tribbleGreySpeed = new Vector2(-2, 2);
            tribbleBrownSpeed = new Vector2(0, 3);
            tribbleOrangeSpeed = new Vector2(1, 4);
        ...
        protected override void LoadContent()
        {
            ...
            tribbleBGSad = Content.Load<Texture2D>("TribbleEndSad");
            ...
            aria = Content.Load<SoundEffect>("Aria").CreateInstance();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (screen == Screen.title)
            {
                ...
                _spriteBatch.DrawString(titleFont, "Press Enter To Start", new Vector2(480, 225), Color.LemonChiffon);
            ...
            {
                _spriteBatch.Draw(tribbleBGSad, bgSadRect, Color.White);
            }
